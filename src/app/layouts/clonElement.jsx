...
import { CloneElementExample as Example } from "../components/examples/clonElement/clonElementExample";
const ClonElementExample = () => {
    return (
        <>
...
export default ClonElementExample;
